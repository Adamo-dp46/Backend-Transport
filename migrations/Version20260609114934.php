 ...
 */
final class Version20260609114934 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bagage (created_at DATETIME DEFAULT NULL, created_from_ip VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, updated_from_ip VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, deleted_from_ip VARCHAR(255) DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, deleted_by INT DEFAULT NULL, etatdelete TINYINT DEFAULT 0, id INT AUTO_INCREMENT NOT NULL, codebagage VARCHAR(255) NOT NULL, nomclient VARCHAR(255) NOT NULL, contactclient VARCHAR(255) NOT NULL, nature VARCHAR(255) NOT NULL, type VARCHAR(255) DEFAULT NULL, poids INT NOT NULL, montant INT NOT NULL, montantforce TINYINT NOT NULL, statut VARCHAR(255) DEFAULT NULL, identreprise INT DEFAULT NULL, voyage_id INT DEFAULT NULL, tarifbagage_id INT DEFAULT NULL, INDEX IDX_A82C571568C9E5AF (voyage_id), INDEX IDX_A82C5715938B927E (tarifbagage_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE personnel (created_at DATETIME DEFAULT NULL, created_from_ip VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, updated_from_ip VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, deleted_from_ip VARCHAR(255) DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, deleted_by INT DEFAULT NULL, etatdelete TINYINT DEFAULT 0, id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, contact VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, identreprise INT DEFAULT NULL, statut VARCHAR(50) DEFAULT NULL, typepersonnel_id INT NOT NULL, image_id INT DEFAULT NULL, INDEX IDX_A6BCF3DE9B4F51A (typepersonnel_id), INDEX IDX_A6BCF3DE3DA5256D (image_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE tarif (created_at DATETIME DEFAULT NULL, created_from_ip VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, updated_from_ip VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, deleted_from_ip VARCHAR(255) DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, deleted_by INT DEFAULT NULL, etatdelete TINYINT DEFAULT 0, id INT AUTO_INCREMENT NOT NULL, identreprise INT DEFAULT NULL, montant INT NOT NULL, libelle VARCHAR(255) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE ticket (created_at DATETIME DEFAULT NULL, created_from_ip VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, updated_from_ip VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, deleted_from_ip VARCHAR(255) DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, deleted_by INT DEFAULT NULL, etatdelete TINYINT DEFAULT 0, id INT AUTO_INCREMENT NOT NULL, identreprise INT DEFAULT NULL, nomclient VARCHAR(255) DEFAULT NULL, contactclient VARCHAR(255) DEFAULT NULL, prix INT NOT NULL, codeticket VARCHAR(255) NOT NULL, voyage_id INT NOT NULL, siege_id INT NOT NULL, gare_id INT NOT NULL, INDEX IDX_97A0ADA368C9E5AF (voyage_id), INDEX IDX_97A0ADA3BF006E8B (siege_id), INDEX IDX_97A0ADA363FD956 (gare_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE trajet (created_at DATETIME DEFAULT NULL, created_from_ip VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, updated_from_ip VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, deleted_from_ip VARCHAR(255) DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, deleted_by INT DEFAULT NULL, etatdelete TINYINT DEFAULT 0, id INT AUTO_INCREMENT NOT NULL, codetrajet VARCHAR(255) NOT NULL, provenance VARCHAR(255) NOT NULL, destination VARCHAR(255) NOT NULL, identreprise INT DEFAULT NULL, tarif_id INT NOT NULL, INDEX IDX_2B5BA98C357C0A59 (tarif_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, avatar VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, statut VARCHAR(50) NOT NULL, is_founder TINYINT NOT NULL, entreprise_id INT DEFAULT NULL, gare_id INT DEFAULT NULL, INDEX IDX_8D93D649A4AEAFEA (entreprise_id), INDEX IDX_8D93D64963FD956 (gare_id), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE voyage (created_at DATETIME DEFAULT NULL, created_from_ip VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, updated_from_ip VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, deleted_from_ip VARCHAR(255) DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, deleted_by INT DEFAULT NULL, etatdelete TINYINT DEFAULT 0, id INT AUTO_INCREMENT NOT NULL, codevoyage VARCHAR(255) NOT NULL, provenance VARCHAR(255) NOT NULL, destination VARCHAR(255) NOT NULL, datedebut DATETIME NOT NULL, datefin DATETIME DEFAULT NULL, identreprise INT DEFAULT NULL, placestotal INT DEFAULT NULL, placesoccupees INT DEFAULT NULL, trajet_id INT NOT NULL, car_id INT DEFAULT NULL, INDEX IDX_3F9D8955D12A823 (trajet_id), INDEX IDX_3F9D8955C3C6F69F (car_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE voyage ADD CONSTRAINT FK_3F9D8955D12A823 FOREIGN KEY (trajet_id) REFERENCES trajet (id)');
