 ...
 */
final class Version20260504145212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE personnel (created_at DATETIME DEFAULT NULL, created_from_ip VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, updated_from_ip VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, deleted_from_ip VARCHAR(255) DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, deleted_by INT DEFAULT NULL, etatdelete TINYINT DEFAULT 0, id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, contact VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, identreprise INT DEFAULT NULL, typepersonnel_id INT NOT NULL, image_id INT DEFAULT NULL, INDEX IDX_A6BCF3DE9B4F51A (typepersonnel_id), INDEX IDX_A6BCF3DE3DA5256D (image_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE trajet (created_at DATETIME DEFAULT NULL, created_from_ip VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, updated_from_ip VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, deleted_from_ip VARCHAR(255) DEFAULT NULL, created_by INT DEFAULT NULL, updated_by INT DEFAULT NULL, deleted_by INT DEFAULT NULL, etatdelete TINYINT DEFAULT 0, id INT AUTO_INCREMENT NOT NULL, codetrajet VARCHAR(255) NOT NULL, provenance VARCHAR(255) NOT NULL, destination VARCHAR(255) NOT NULL, orderindex INT DEFAULT NULL, identreprise INT DEFAULT NULL, tarif_id INT NOT NULL, INDEX IDX_2B5BA98C357C0A59 (tarif_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
